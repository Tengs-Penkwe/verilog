...
void Vmy_design::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+2,"my_design o_led", false,-1);
        tracep->declBus(c+3,"my_design counter", false,-1, 11,0);
    }
}
...
void Vmy_design::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+2,(vlTOPp->o_led));
        tracep->fullSData(oldp+3,(vlTOPp->my_design__DOT__counter),12);
    }
}
